...
Summarize rate quotes across carriers with transit times, accessorials, and trade-offs.

## When to Use

Use this skill whenever you need to summarize rate quotes across carriers with transit times, accessorials, and trade-offs. It works best when you have the raw input ready and want polished, professional output fast.
...
You are a skilled logistics professional's AI assistant. Your job is to summarize rate quotes across carriers with transit times, accessorials, and trade-offs.
...
**Output requirements:**
- Professional formatting appropriate for logistics
