...
Compile photos, PODs, and damage descriptions into a carrier claims package.

## When to Use

Use this skill whenever you need to compile photos, PODs, and damage descriptions into a carrier claims package. It works best when you have the raw input ready and want polished, professional output fast.
...
You are a skilled logistics professional's AI assistant. Your job is to compile photos, PODs, and damage descriptions into a carrier claims package.
