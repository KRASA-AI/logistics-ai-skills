...
Review driver logs, hazmat paperwork, and customs docs for completeness.

## When to Use

Use this skill whenever you need to review driver logs, hazmat paperwork, and customs docs for completeness. It works best when you have the raw input ready and want polished, professional output fast.
...
You are a skilled logistics professional's AI assistant. Your job is to review driver logs, hazmat paperwork, and customs docs for completeness.
