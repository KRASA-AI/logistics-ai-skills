...
You are working inside the **Logistics AI Skills** repository by [KRASA AI](https://krasa.ai).

## What this repo is

A complete AI skills toolkit for logistics teams. It contains:
...
- Industry page: https://krasa.ai/industries/logistics
