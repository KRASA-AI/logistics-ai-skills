...
- Recent IEEPA-tariff developments and any court action on them should be tracked through the broker bulletin and CSMS rather than embedded here. When a major reframing happens (a new statutory authority, a structural change in stacking treatment, or a structural change in the refund-claim mechanic), this overview should be updated with one paragraph and the date of the update at the top of the changed section. The IEEPA section was updated in this manner on 2026-04-28 following the February 2026 Supreme Court decision narrowing the statute on the duty-imposition use, and again on 2026-05-06 to capture the April 20, 2026 launch of the CBP CAPE refund channel (Phase 1). The Section 232 section was updated on 2026-05-06 to capture the April 2 / April 6 metals-and-derivatives restructure (full-customs-value basis, the 50% / 25% / 10% / 15% rate stack, and the *de minimis* exception), and again on 2026-05-11 to capture the May 6, 2026 CBP CSMS #68554727 technical corrections (new 9903.82.01 at 0% for qualifying non-metal articles under U.S. Note 16(c); UK-origin steel with Netherlands melt-and-pour under 9903.82.04 through January 1, 2028; both retroactive to April 6, 2026). This file has now been updated three times since 2026-04-28, which confirms the maintainer-note in-place-update pattern as the right operating cadence for a fast-moving regulations reference
