...
*Update — 2026-06-01.* The first U.S.–Mexico bilateral negotiating round was held in Mexico City May 26–27, 2026 and concluded May 29 with a joint USTR / Secretaría de Economía statement. The negotiating teams were led by Mexican Secretary of Economy Marcelo Ebrard and Deputy USTR Jeffrey Gerrish; Ambassador Greer met separately with the Mexican steel industry and with auto-sector CEOs from GM México, Nissan Mexicana, Mazda, BMW, Stellantis, and Mercedes-Benz México. The joint statement names three substantive workstreams — **automotive rules of origin**, **steel and aluminum**, and **economic security** — and instructs the negotiating teams "to focus on measures to ensure the benefits of the Agreement accrue primarily to the parties, including by reducing dependence on imports from outside the region, strengthening rules of origin, and enhancing the security of North American supply chains." That instructional language is the operator-relevant signal: the direction-of-travel on automotive RVC tightening, China-affiliated content restrictions, and supply-chain-security provisions is now anchored in a joint communiqué rather than only in trade-press preview pieces. **No specific numerical RVC threshold, LVC threshold, or steel / aluminum melted-and-poured percentage has been published**; the joint statement is directional, not text-of-amendment, and Ambassador Greer separately reiterated on May 26 that the U.S. plans to maintain Section 232 tariffs on steel and aluminum from Mexico (and on Canada) pending resolution of the bilateral trade deficit. Secretary Ebrard publicly characterized the 50% Section 232 metals rate as "unsustainable" given the 36.6% drop in Mexico's 2025 steel exports to the U.S. and the 5.1% decline in early-2026 Mexican auto exports — the negotiating gap on metals is real and the producer should not bake any rate-relief assumption into a 2026 supplier-program decision. The agreed round schedule is **second round June 16–17, 2026 in Washington, D.C.** (adding agriculture and fair-competition / level-playing-field to the agenda alongside continued automotive ROO discussion) and **third round the week of July 20, 2026 in Mexico City** (focused on resolving pending issues). The July 1 statutory decision date will not be met in substance; trade-press consensus and analyst framing continue to project the Joint Review extends past July 1 with amendments rather than concluding on the statutory window. **Canada track lags** — as of this overview the Canada-side bilateral track has not produced a parallel statement, so the operator should expect the U.S.-Mexico track to drive the substantive text and the Canada-side text to be reconciled later. The operator-side posture is unchanged from the pre-round entry: assume extension-with-amendments, do not bake the current 75% automotive RVC / 40% LVC / current steel-and-aluminum melted-and-poured percentages into a multi-year program decision without a sensitivity check, and re-check this section after each subsequent round for substantive numerical or scope language.
...
The 2026 Joint Review Pressure Areas section was updated in place on 2026-06-01 to capture the first U.S.–Mexico bilateral negotiating round (May 26–27 Mexico City, joint statement May 29) — first structural in-place update to this file since initial build. The next structural update on this section should follow the second round (June 16–17 Washington) or the third round (week of July 20 Mexico City) if either produces substantive numerical or scope text on automotive ROO, steel / aluminum, or supply-chain-security provisions. Trade-press preview pieces between rounds should not drive an update; only the joint-statement output of a concluded round, the Federal Register notice of any amendment language, or a USTR notice that materially changes the operator-side posture should drive the next in-place update.
